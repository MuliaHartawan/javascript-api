        ...
        try {
            ...
            <div class="movie-info border-gray-800">
                <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
                    <img src="https://image.tmdb.org/t/p/w500${this._movie.poster_path}" alt="" class="w-70 md:w-96">
                    <div class="md:ml-24">
                        <h2 class="text-4xl mt-4 md:mt-0 font-semibold">${this._movie.original_title}</h2>
